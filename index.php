                ...
                <form action="index.php" method="post" class="space-y-6">
                    <?php if (!$loginSucessful && $_SERVER['REQUEST_METHOD'] == "POST") {?>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="email" name="chatEmail" id="email" placeholder="example@example.com" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:-outline-offset-2 focus:outline-blue-900 sm:text-sm/6" required/>
                            </div>
                        </div>
                        <div>
                            <div class="flex items-center justify-between">
                                <label for="password" class="block text-sm/6 font-medium text-gray-900 mb-0">Password: </label>
                            </div>
                            <div class="mt-2">
                                <input type="password" name="chatPassword" id="password" placeholder="********" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:-outline-offset-2 focus:outline-blue-900 sm:text-sm/6" required/>
                            </div>
                        </div>
